...
const AddressData = ({setAddressData}) => {
  ...
  return <>
    ...
    <div className="d-flex justify-content-end mt-3">
      <Button variant="warning" size="sm" disabled={notSelect} onClick={_ => history.push('/checkout/confirm')}>Selanjutnya</Button>
    </div>
  </>
}
...
const Confirmation = ({data, onClick}) => {
  ...
  return <>
    ...
    <div className="d-flex justify-content-between mt-3">
      <Button variant="warning" size="sm" onClick={_ => history.push('/checkout')}>Sebelumnya</Button>
      <Button variant="danger" size="sm" onClick={onClick}>BAYAR</Button>
    </div>
  </>
}
